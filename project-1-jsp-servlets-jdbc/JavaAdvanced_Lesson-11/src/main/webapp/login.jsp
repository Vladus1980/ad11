    ...
    <div class="login-page">
        <div class="form">
            <form class="register-form">
                ...
                <input class="lastName" type="text" placeholder="Призвище" />
                ...
                <label><input id="admin" name="accessLevel" type="radio" value="admin">Адмін</label>
                <button class="register" type="button">Зареєструватися</button>
                <p class="message">Зареєстровані? <a href="#">Увійти</a></p>
            </form>
            <form class="login-form">
                <input class="email" type="text" placeholder="Логін" />
                <input class="password" type="password" placeholder="Пароль" />
                <button class="login" type="button">Увійти</button>
                <p class="message">Ще не зареєстровані <a href="#">Зареєструватися</a></p>
            </form>
        </div>
    </div>
