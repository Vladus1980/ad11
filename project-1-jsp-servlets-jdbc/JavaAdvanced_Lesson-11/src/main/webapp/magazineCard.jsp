...
<head>
    ...
    <title>Журнали "${magazine.title}"</title>
</head>
                ...
                <div class="col-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p>Тривалість підписки:<br>
                            <input class="subscribePeriod" type="number" max="12" min="1" value="1"> міс.</p>

                            <button type="button" class="btn btn-primary openModal" data-toggle="modal" data-target="#buyMagazineModal">У кошик</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Оформлення підписки "${magazine.title}"</h5>
                        ...
                        <script language="javascript">var subscribePeriod = $('.subscribePeriod').val()</script>
                            Ви бажаєте додати підписку <span id="subscribePeriod"></span> міс. на журнал "${magazine.title}" у кошик?
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Отмена</button>
                            <button type="button" magazineID="${magazine.id}" class="btn btn-primary buy-magazine">У кошик</button>
                        </div>
                    </div>
                </div>
            </div>
